...
const AUDIT_TEMPLATES: Record<string, string> = {
  ...
  "vendor.created": "{actor} added a vendor",
  "vendor.updated": "{actor} updated a vendor",
  "vendor.status_changed": "{actor} changed vendor status",
  "vendor.preferred_changed": "{actor} changed preferred vendor status",
  "vendor.network_visibility": "{actor} changed shared network visibility",
  "vendor_network_link.created": "{actor} created a vendor network link",
  "vendor_network_link.revoked": "{actor} revoked a vendor network link",
  "vendor_network_submission.created": "{actor} submitted a vendor via shared network",
  "vendor_network_submission.approved": "{actor} approved a network vendor submission",
  "vendor_network_submission.rejected": "{actor} rejected a network vendor submission",
  "client.invite": "{actor} invited a client user",
  "vendor.invite": "{actor} invited a vendor user",
  "user.invited": "{actor} invited a user",
  "user.invite_resent": "{actor} resent a user invitation",
  "user.invite_cancelled": "{actor} cancelled a user invitation",
  "user.access_removed": "{actor} removed user access",
  "user.role_changed": "{actor} changed a user role",
